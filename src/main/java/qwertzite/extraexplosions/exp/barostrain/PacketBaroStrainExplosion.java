...
public class PacketBaroStrainExplosion extends AbstractPacket implements PacketToClient {
	...
	public PacketBaroStrainExplosion() {}
	
	public PacketBaroStrainExplosion(double xIn, double yIn, double zIn, float strengthIn,
	...
	public AbstractPacket handleClientSide(Player player, Context ctx) {
		var explosion = new BaroStrainExplosion(player.getLevel(), (Entity) null, this.posX, this.posY,
